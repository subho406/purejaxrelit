...
from purejaxrl.wrappers import BatchEnvWrapper, OptimisticResetVecEnvWrapper
...
def make_train(config, env, env_params, rnn_module: Callable = None, rnn_carry_init: Callable = None):
    """
